...
class DownloadableFileModel < Model
  ...
  # This must match the type generated by the JSONAPI for consistency. It is not
  # the source of the API type and therefore it is possible for conflicts to occur
  def type
    raise NotImplementedError
  end
  ...
  def storage_path
    File.join(self.class.base_storage_path, type, filename)
  end

  def download_url
    File.join(self.class.base_download_url, type, filename)
  end
